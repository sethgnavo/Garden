...
import com.spaceapps.garden.activities.MessagingActivity;
...
public class ChannelListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MessagingActivity) getActivity()).setTitle(getResources().getString(R.string
                .all_group_channels));

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.list_discussions);
    ...
    private void setUpChannelListAdapter() {
        ...
        mChannelListAdapter.setOnItemLongClickListener(new  ChannelListAdapter
