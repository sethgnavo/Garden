...
import com.spaceapps.garden.utils.WebUtils;
...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            mChannelUrl = PreferenceUtils.getUrl(getActivity());
        } else {
            mChannelUrl = PreferenceUtils.getUrl(getActivity());
    ...
    private void setUpChatListAdapter() {
        mChatAdapter.setItemClickListener(new ChatAdapter.OnItemClickListener() {
            ...
            public void onUserMessageItemClick(UserMessage message) {
                ...
                if (message.getCustomType().equals(ChatAdapter.URL_PREVIEW_CUSTOM_TYPE)) {
                    try {
        ...
        new WebUtils.UrlPreviewAsyncTask() {
            ...
            protected void onPostExecute(UrlPreviewInfo info) {
                ...
                try {
                    ...
                    tempUserMessage = mChannel.sendUserMessage(text, jsonString, ChatAdapter.URL_PREVIEW_CUSTOM_TYPE, handler);
                } catch (Exception e) {
