package com.spaceapps.garden.utils;
...
public class PreferenceUtils {
    ...
    public static final String PREFERENCE_KEY_CHANNEL = "channel";
    ...
    public static void setUrl(Context context, String tf) {
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString(PREFERENCE_KEY_CHANNEL, tf).apply();
    }

    public static String getUrl(Context context) {
        return getSharedPreferences(context).getString(PREFERENCE_KEY_CHANNEL, "meh");
    }
